    ...
    <footer className="bg-slate-50 border-t border-slate-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-slate-900 font-semibold mb-6 text-lg">Navigatie</h4>
            <nav className="flex flex-col gap-3">
              {[...publicNavItems.slice(1), contactNavItem].map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className="text-slate-600 hover:text-[var(--rb-primary)] transition-colors duration-200"
                >
          ...
          {/* Treatments */}
          <div>
            <h4 className="text-slate-900 font-semibold mb-6 text-lg">Behandelingen</h4>
            <nav className="flex flex-col gap-3">
          ...
          <div>
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center gap-3 text-slate-600 hover:text-[var(--rb-primary)] transition-colors group"
              >
                <div className="w-10 h-10 rounded-xl bg-[var(--rb-light)] flex items-center justify-center text-[var(--rb-primary)]">
              ...
              <div className="flex items-start gap-3 text-slate-600">
                <div className="w-10 h-10 rounded-xl bg-[var(--rb-light)] flex items-center justify-center text-[var(--rb-primary)] flex-shrink-0">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
