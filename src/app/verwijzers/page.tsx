        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="flex items-start gap-4 p-6 bg-slate-50 rounded-xl">
              <div className="flex-shrink-0 w-12 h-12 bg-[var(--rb-primary)]/10 rounded-xl flex items-center justify-center">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 mb-1">{card1Title}</h3>
                <p className="text-sm text-slate-600">{card1Content}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-6 bg-slate-50 rounded-xl">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 mb-1">{card2Title}</h3>
                <p className="text-sm text-slate-600">{card2Content}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-6 bg-slate-50 rounded-xl">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 mb-1">{card3Title}</h3>
                <p className="text-sm text-slate-600">{card3Content}</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space-y-2">
                      {behandeling.aandoeningen.map((aandoening) => (
                        <li key={aandoening.id} className="flex items-start gap-2 text-slate-700">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-1">{step1Title}</h3>
                    <p className="text-slate-600">{step1Content}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-1">{step2Title}</h3>
                    <p className="text-slate-600">{step2Content}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-1">{step3Title}</h3>
                    <p className="text-slate-600">{step3Content}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-50 rounded-2xl p-8">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-[var(--rb-primary)]/10 rounded-xl flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <a href="tel:+32498686842" className="font-semibold text-slate-900 hover:text-[var(--rb-primary)]">
                      +32 498 68 68 42
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-slate-500">E-mail verwijzingen</p>
                    <a href="mailto:verwijzers@revabrain.be" className="font-semibold text-slate-900 hover:text-[var(--rb-primary)]">
              ...
              <div className="pt-6 border-t border-slate-200">
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center w-full px-6 py-3 bg-[var(--rb-primary)] text-white font-semibold rounded-xl hover:bg-[var(--rb-primary-dark)] transition-colors"
                >
                  Contactformulier
                </Link>
              </div>
